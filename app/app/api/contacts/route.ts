...
// Helper to create OAuth client from session
...
export async function POST(request: NextRequest) {
    try {
        ...
        // Store reminder preference in userDefined field
        contactData.userDefined = [
...
// PATCH: Update contact (add phone, toggle reminders)
